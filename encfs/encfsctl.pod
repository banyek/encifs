...
encifsctl - administrative tool for working with EnciFS filesystems

=head1 SYNOPSIS

B<encifsctl> [I<command> I<command_args>]

B<encifsctl> [info] I<rootdir>

B<encifsctl> passwd I<rootdir>

B<encifsctl> showcruft I<rootdir>

B<encifsctl> decode [--extpass=prog] I<rootdir> [encoded name ...]

B<encifsctl> encode [--extpass=prog] I<rootdir> [plaintext name ...]

B<encifsctl> cat [--extpass=prog] [--reverse] I<rootdir> <(cipher|plain) filename>

=head1 DESCRIPTION

B<encifsctl> is an administrative tool for working with EnciFS filesystems.  It
...
password - just like with encifs.
...
Show information about an encrypted filesystem:
 ...
 % encifsctl info ~/.crypt

 Version 5 configuration; created by EnciFS 1.1 (revision 20040504)
